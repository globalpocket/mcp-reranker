...
- **モデルの柔軟性**: HuggingFace 上の CrossEncoder モデルを自由に指定可能です（デフォルト: `BAAI/bge-reranker-v2-m3`）。
...
- `model_name` (string, 任意): 使用する HuggingFace のモデル名。デフォルトは `"BAAI/bge-reranker-v2-m3"`。
